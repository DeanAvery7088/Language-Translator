...
public:
    ...
    void test_iter4_simple1 ( void ) { codegen_tests ( "iter4_simple1", true ); }
    ...
    void test_your_code_1b ( void ) { codegen_tests ( "my_code_1b", true ) ; }
    void test_your_code_1c ( void ) { codegen_tests ( "my_code_1c", true ) ; }
